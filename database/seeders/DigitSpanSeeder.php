...
class DigitSpanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('questions')->insert([
            ['category_id' => 3, 'pertanyaan' => '5 3 7 4 5', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '53745'],
            ['category_id' => 3, 'pertanyaan' => '6 9 5 0 2', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '69502'],
            ['category_id' => 3, 'pertanyaan' => '5 2 4 2 7', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '52427'],
            ['category_id' => 3, 'pertanyaan' => '1 6 8 0 5', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '16805'],
            ['category_id' => 3, 'pertanyaan' => '4 2 5 0 7 3', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '425073'],
            ['category_id' => 3, 'pertanyaan' => '7 0 5 6 9 3', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '705693'],
            ['category_id' => 3, 'pertanyaan' => '4 9 8 1 6 4', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '498164'],
            ['category_id' => 3, 'pertanyaan' => '5 9 0 5 7 9 2', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '5905792'],
            ['category_id' => 3, 'pertanyaan' => '8 6 0 2 9 0 5', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '8602905'],
            ['category_id' => 3, 'pertanyaan' => '1 4 9 1 3 9 6', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '1491396'],
            ['category_id' => 3, 'pertanyaan' => '0 4 6 2 8 2 3', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '0462823'],
            ['category_id' => 3, 'pertanyaan' => '5 8 7 4 7 2 3', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '5874723'],
            ['category_id' => 3, 'pertanyaan' => '3 9 4 2 7 3 6', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '3942736'],
            ['category_id' => 3, 'pertanyaan' => '6 3 5 4 0 2 9', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '6354029'],
            ['category_id' => 3, 'pertanyaan' => '5 3 6 0 8 1 6', 'kategori_soal' => null, 'type' => 'forward', 'jawaban_benar' => '5360816'],
        ]);
        ...
        // ]);
        DB::table('questions')->insert([
            ['category_id' => 3, 'pertanyaan' => '6 0 2 6 9', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '96206'],
            ['category_id' => 3, 'pertanyaan' => '7 3 9 1 0', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '01937'],
            ['category_id' => 3, 'pertanyaan' => '6 9 8 5 9', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '95896'],
            ['category_id' => 3, 'pertanyaan' => '4 9 8 4 9', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '94894'],
            ['category_id' => 3, 'pertanyaan' => '3 5 7 8 3', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '38753'],
            ['category_id' => 3, 'pertanyaan' => '7 3 1 2 3', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '32137'],
            ['category_id' => 3, 'pertanyaan' => '7 3 8 2 0', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '02837'],
            ['category_id' => 3, 'pertanyaan' => '1 8 7 1 8', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '81781'],
            ['category_id' => 3, 'pertanyaan' => '7 0 3 6 7', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '76307'],
            ['category_id' => 3, 'pertanyaan' => '1 5 4 2 9', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '92451'],
            ['category_id' => 3, 'pertanyaan' => '9 4 3 9 6', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '69349'],
            ['category_id' => 3, 'pertanyaan' => '1 6 8 7 5', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '57861'],
            ['category_id' => 3, 'pertanyaan' => '4 1 6 4 7', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '74614'],
            ['category_id' => 3, 'pertanyaan' => '0 8 9 3 7', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '73980'],
            ['category_id' => 3, 'pertanyaan' => '5 3 7 5 7', 'kategori_soal' => null, 'type' => 'backward', 'jawaban_benar' => '75735'],
        ]);
    }
}
